...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ct', '0070_booking_amount_booking_is_paid_booking_session_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='ct.thread')),
